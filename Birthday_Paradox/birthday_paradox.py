...
while ((p_k > p_n) and p_n!=0) :
    ...
    p_k = p_k * (365-k)/365
    k += 1
# for the case when 100% proabability is required we can use PHP to say that it will be true for k=366. For k=365 it is still possible that every person has a different birthday
if(p_n==0):
    k=366
